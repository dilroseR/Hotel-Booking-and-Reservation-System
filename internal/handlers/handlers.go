...
import (
	...
	"hotelManagement/internal/repository"
	"hotelManagement/internal/repository/dbrepo"
...
func (m *Repository) PostReservation(w http.ResponseWriter, r *http.Request) {
	...
	Dear %s:, <br>
	This is confirming your room reservation from %s to %s.`, reservation.FirstName, reservation.StartDate.Format("2006-01-02"), reservation.EndDate.Format("2006-01-02"))

	msg := models.MailData{
		To:       reservation.Email,
		From:     "GoLangHotel@team.com",
	...
	//Confirmation email to hotel owner
	htmlMsg = fmt.Sprintf(`<strong>Reservation Confirmation</strong><br>
...
// AdminNewReservations shows all reservations in admin page
...
// AdminShowReservation shows the  reservations in admin page
func (m *Repository) AdminShowReservation(w http.ResponseWriter, r *http.Request) {
	...
	res, err := m.DB.GetOneReservationByID(id)
	if err != nil {
		helpers.ServerError(w, err)
		return 
	}
